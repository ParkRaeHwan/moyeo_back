...
현재 입력된 예산은 %d원이다.
    ...
    - 만약 예산이 200,000~400,000원 사이라면, **저예산 여행**으로 간주한다.
    → 반드시 “모텔” 또는 “게스트하우스”만 선택하고, “호텔”, “펜션”, “리조트”는 금지한다.
    - 예산이 400,000~600,000원일 경우, **중간 예산 여행**으로 간주한다.
    → “펜션”, “한옥스테이”, “콘도” 중에서만 선택하라.
    - 예산이 600,000~800,000원이면, “호텔”만 사용하라.
    - 예산이 800,000원 이상이면, “리조트” 또는 “고급 호텔”만 사용하라.
